...
async function plugin(imports, register) {
    ...
    //`markup` AND `snapshot` ARE NOT HERE. They write what is on the screen to
    //disk, which is a feature rather than a window's capability -- see
    //../../debug-snapshot/cli.js, which is deletable in one piece.
    cli.command('capture', {
