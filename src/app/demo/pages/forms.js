...
module.exports = function Forms(props) {
    ...
    function save() {
        ...
        toast('saved to the config store', 'success', 'save');
    }
            ...
            <Section title="Forms" lead="validated by the browser, stored by the app"
                ...
                <div className="row g-4">
                    ...
                    <div className="col-lg-5">
                        <Card title="What is stored" subtitle="config, so it survives a restart">
                        ...
                        <Alert variant="secondary" className="mt-3" icon="info-circle">
                            <code>config</code> is localStorage and <code>session</code> is sessionStorage,
